...
#define MAZESIZE_X		(19)		//迷路の大きさ(MAZESIZE_X * MAZESIZE_Y)迷路
#define MAZESIZE_Y		(19)		//迷路の大きさ(MAZESIZE_X * MAZESIZE_Y)迷路
...
#define BACK_STRAIGHT_MODE 6
#define ORBIT_FOLLOWING_MODE 7
#define FF_MODE 8
