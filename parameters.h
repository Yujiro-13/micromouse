...
#define REF_SEN_R 1120 //マウスを迷路中央に置??た時のセンサの値
#define REF_SEN_L 1273 //マウスを迷路中央に置??た時のセンサの値

#define TH_SEN_R 50 //壁があるか否か???閾値	車体を区画の左へ??せた時???センサ値(壁あ??)
#define TH_SEN_L 50 //壁があるか否か???閾値	車体を区画の右へ??せた時???センサ値(壁あ??)
#define TH_SEN_FR 50 //壁があるか否か???閾値
#define TH_SEN_FL 50 //壁があるか否か???閾値
