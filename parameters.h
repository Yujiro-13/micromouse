...
#define REF_SEN_R 1120 //マウスを迷路中央に置いた時のセンサの値
#define REF_SEN_L 1273 //マウスを迷路中央に置いた時のセンサの値

#define TH_SEN_R 50 //壁があるか否かの閾値	車体を区画の左へ寄せた時のセンサ値(壁あ??)
#define TH_SEN_L 50 //壁があるか否かの閾値	車体を区画の右へ寄せた時のセンサ値(壁あ??)
...
#define TURN_ACCEL (PI * 2)        //超信地旋回の??速度	[rad/s^2]
